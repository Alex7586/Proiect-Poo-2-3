...
void display(std::vector<Shape*> shapes) {
...
void displayVisual(std::vector<Shape*> shapes) {
...
void distance3d() {
    ...
    std::cin >> std::get<2>(B);
    std::cout << "\nDistanta dintre punctele A si B: ";
    std::cout << ThreeDimensionalShape::getDistance(A, B);
}

int main()
{   
    std::vector<Shape*> shapes;
    Circle cerc(-10, -10, 30);
    Rectangle rect(2,4);
    Triangle trig({ std::make_pair(0,0), std::make_pair(2,3), std::make_pair(10,0) });
    Cuboid cub(2, 2, 2);
    TwoDimensionalShape s({ std::make_pair(-5,-12), std::make_pair(2,3), std::make_pair(10,5), std::make_pair(5,-10)});

    shapes.push_back(&rect);
    shapes.push_back(&trig);
    shapes.push_back(&cub);
    shapes.push_back(&s);
    shapes.push_back(&cerc);
